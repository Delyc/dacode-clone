...
function Course(){
  ...
  <div className='w-5/6 xl:w-2/5 xl:h-4/5  flex justify-end'>
        ...
        <div className='flex flex-col w-full items-center xl:w-1/2 gap-10 xl:items-start xl:gap-4'>
            ...
            <div className='flex flex-col  items-center gap-2 xl:flex xl:flex-row xl:gap-3 '><img className='w-12' src="https://dacade-nearbalkans.netlify.app/_ipx/w_32,q_75/%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png?url=%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png&w=32&q=75" /><p className='text-text-gray text-4xl text-center xl:text-[18px] module'>Essential NEAR concepts</p></div>
            <div className='flex flex-col items-center gap-2 xl:flex xl:flex-row xl:gap-3 xl:items-center'><img className='w-12' src="https://dacade-nearbalkans.netlify.app/_ipx/w_32,q_75/%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png?url=%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png&w=32&q=75" /><p className='text-text-gray text-4xl text-center xl:text-[18px]'>How to write smart contracts on NEAR</p></div>
            <div className='flex flex-col items-center gap-2 xl:flex xl:flex-row xl:gap-3 xl:items-center'><img className='w-12' src="https://dacade-nearbalkans.netlify.app/_ipx/w_32,q_75/%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png?url=%2F_next%2Fstatic%2Fmedia%2Fcontract.ba589e37.png&w=32&q=75" /><p className='text-text-gray text-4xl text-center xl:text-[18px] module leading-[50px]'>How to build dapps on the NEAR blockchain</p></div>
