...
function StartCourse(){
    return (
        <>
        <section className='flex flex-col-reverse items-center xl:flex xl:justify-between  mt-20'>
            <div className='flex flex-col items-center gap-5'>
            <h4 className='font-medium module text-5xl'>NEAR Development 101</h4>
            <button className='mt-5 border border-slate-300 py-6 px-10 rounded-full text-3xl xl:text-xl'> <Link href="#">Start the Course</Link> </button>
            </div>
