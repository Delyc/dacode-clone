  ...
  return (
    <>
      <footer className="module flex py-32 flex-col px-10 xl:flex xl:flex-col xl:items-center xl:gap-6 xl:mt-10">
        <p className="text-center text-4xl text-black-secondary leading-[60px]">
        ...
        <div className="py-20 flex gap-6 items-center justify-between pl-4">
          <svg
        ...
        <ul className=" flex flex-col gap-5 items-center text-3xl xl:flex justify-between xl:gap-8 xl:text-[18px]">
          <li className=" text-4xl module text-black-secondary">
            <Link className="module text-black-secondary" href="#">NEAR Balkans 2022</Link>
          </li>
          <li className="module text-4xl module text-black-secondary">
        ...
        <p className="module mt-20 leading-[60px] text-4xl  text-black-secondary text-center">
