...
function HeroSection(){
    ...
    return (
        ...
        <section className=" flex flex-col items-center py-44 gap-5 px-10">
            <h1 className="text-center font-medium leading-[100px] mt-32">Get <span className=" text-transparent  bg-clip-text bg-gradient-to-b from-[#9092fb] via-[#86b5ef] to-[#7bdde2]"
